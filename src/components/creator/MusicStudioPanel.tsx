...
{/* Premium Music AI Overview */}
<div className="mt-5 rounded-3xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/10 via-slate-900 to-slate-950 p-5">
  ...
  <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
    ...
    <div>
      ...
      <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300">
        Create original songs, instrumentals, jingles, worship music,
        birthday songs, campaign music and professional audio
        in just a few clicks.
      </p>
    </div>

    <div className="rounded-2xl border border-cyan-400/20 bg-cyan-500/10 px-5 py-4 text-center">
  ...
  <div className="mt-6 grid gap-3 md:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="rounded-2xl bg-black/20 p-4">
      ...
      <p className="mt-1 text-xs text-slate-300">
        Male, female, choir and commercial voices.
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-black/20 p-4">
      ...
      <p className="mt-1 text-xs text-slate-300">
        Original music for creators, churches and businesses.
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-black/20 p-4">
      ...
      <p className="mt-1 text-xs text-slate-300">
        Download high-quality audio after generation.
      </p>
    </div>
    ...
    <div className="rounded-2xl bg-black/20 p-4">
      ...
      <p className="mt-1 text-xs text-slate-300">
        Add directly into AI Music Video Studio.
      </p>
    </div>
      ...
      <div className="mt-5 space-y-5"> 
        <div className="mt-5 rounded-3xl border border-white/10 bg-slate-950/60">
  ...
  >
    <div>
      ...
      <p className="mt-1 text-xs text-slate-300">
        Click to view generation prices.
      </p>
