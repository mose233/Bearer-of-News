...
export default function MusicStudioPanel({
  ...
  const handleGenerateAudio = async () => {
    ...
    setSongStatus("Sending your music request to xnewsapp ...");
    ...
    try {
      ...
      setSongStatus(
        `${config.title} real AI audio generated by xnewsapp.com and ready to play.`
      );
    } catch (error) {
      const message =
          ...
          <div className="space-y-4 rounded-3xl border border-cyan-400/20 bg-cyan-500/10 p-4">
            <div>
              ...
              <p className="mt-1 text-xs font-medium leading-5 text-slate-300">
                Real AI audio generated by xnewsapp.com.
              </p>
            </div>
