 ...
 const handleExportNarratedMp4 = async () => {
  ...
  return (
    <main className="min-h-screen bg-[#0B1020] text-slate-100">
      <div className="mx-auto w-full px-3 py-4 pb-24 sm:px-4 lg:px-6 lg:py-5">
       <header className="mb-3 rounded-[1.25rem] border border-white/10 bg-[#111827] px-3 py-3 shadow-creator sm:px-4 lg:mb-5 lg:py-4">
        ...
        <div className="grid grid-cols-1 gap-4">
          <section ref={livePreviewSectionRef} className="space-y-4">
            <Card className="rounded-[1.25rem] border border-white/10 bg-[#111827] text-white shadow-creator">
              <CardHeader className="border-b border-white/10 px-3 py-2.5 sm:px-4 sm:py-3">
